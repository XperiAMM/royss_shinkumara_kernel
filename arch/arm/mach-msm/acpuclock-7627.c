...
//Define stock max PLL4 freq - khristian
...
static struct clkctl_acpu_speed pll0_960_pll1_245_pll2_1200_pll4_1008[] = {
	...
	{ 1, 245760, ACPU_PLL_1, 1, 0, 30720, 3, 3, 61440 },
	{ 0, 300000, ACPU_PLL_2, 2, 3, 37500, 3, 4, 122880 },
	{ 0, 320000, ACPU_PLL_0, 4, 2, 40000, 3, 4, 122880 },
	{ 1, 400000, ACPU_PLL_4, 6, 1, 50000, 3, 4, 120000 },
	{ 0, 480000, ACPU_PLL_0, 4, 1, 60000, 3, 5, 122880 },
	{ 1, 504000, ACPU_PLL_4, 6, 1, 63000, 3, 6, 160000 },
	{ 0, 600000, ACPU_PLL_2, 2, 1, 75000, 3, 6, 160000 },
	{ 1, 645760, ACPU_PLL_4, 6, 0, 80720, 3, 6, 160000 },
	{ 1, 700800, ACPU_PLL_4, 6, 0, 87500, 3, 6, 160000 },
	{ 1, 800000, ACPU_PLL_4, 6, 0, 100000, 3, 7, 200000 },
	{ 1, 1008000, ACPU_PLL_4, 6, 0, 126000, 3, 7, 200000 },
        { 0, 1036800, ACPU_PLL_4, 6, 0, 129600, 3, 7, 208000 },
        { 0, 1056000, ACPU_PLL_4, 6, 0, 132000, 3, 7, 208000 },
        { 0, 1113600, ACPU_PLL_4, 6, 0, 139200, 3, 7, 208000 },
        { 1, 1152000, ACPU_PLL_4, 6, 0, 144000, 3, 7, 208000 },
        { 0, 1190400, ACPU_PLL_4, 6, 0, 148800, 3, 7, 208000 },
	{ 0, 1209600, ACPU_PLL_4, 6, 0, 151200, 3, 7, 208000 },
        { 0, 1228800, ACPU_PLL_4, 6, 0, 153600, 3, 7, 208000 },
	{ 0, 1248000, ACPU_PLL_4, 6, 0, 156000, 3, 7, 216000 },
        { 0, 1267200, ACPU_PLL_4, 6, 0, 158400, 3, 7, 216000 },
	{ 0, 1280000, ACPU_PLL_4, 6, 0, 160000, 3, 7, 216000 }, //Max for PLL
	{ 0, 1292800, ACPU_PLL_4, 6, 0, 165000, 3, 7, 216000 },
	{ 0 }
};
...
static struct clkctl_acpu_speed pll0_960_pll1_737_pll2_1200_pll4_1008[] = {
	...
	{ 1, 504000, ACPU_PLL_4, 6, 1, 63000, 3, 6, 160000 },
	{ 0, 600000, ACPU_PLL_2, 2, 1, 75000, 3, 6, 160000 },
	{ 0, 645760, ACPU_PLL_4, 6, 0, 80720, 3, 6, 160000 },
	{ 0, 700800, ACPU_PLL_4, 6, 0, 87500, 3, 6, 160000 },
	{ 1, 800000, ACPU_PLL_4, 6, 0, 100000, 3, 7, 200000 },
	{ 1, 1008000, ACPU_PLL_4, 6, 0, 126000, 3, 7, 200000 },
        { 0, 1036800, ACPU_PLL_4, 6, 0, 129600, 3, 7, 208000 },
        { 0, 1056000, ACPU_PLL_4, 6, 0, 132000, 3, 7, 208000 },
        { 0, 1113600, ACPU_PLL_4, 6, 0, 139200, 3, 7, 208000 },
        { 0, 1152000, ACPU_PLL_4, 6, 0, 144000, 3, 7, 208000 },
        { 0, 1190400, ACPU_PLL_4, 6, 0, 148800, 3, 7, 208000 },
	{ 1, 1209600, ACPU_PLL_4, 6, 0, 151200, 3, 7, 208000 },
        { 0, 1228800, ACPU_PLL_4, 6, 0, 153600, 3, 7, 208000 },
        { 0, 1267200, ACPU_PLL_4, 6, 0, 158400, 3, 7, 216000 },
	{ 1, 1280000, ACPU_PLL_4, 6, 0, 160000, 3, 7, 216000 }, //Max for PLL
	{ 0, 1292800, ACPU_PLL_4, 6, 0, 165000, 3, 7, 216000 },
	{ 0 }
};
...
static void acpuclk_set_div(const struct clkctl_acpu_speed *hunt_s)
{
	...
	//Overclocking PLL4 - khristian
		...
		if (hunt_s->a11clk_khz > 1280000) {
			...
			//pr_warning("khristian: Changed PLL4 to (%d)\n", hunt_s->a11clk_khz/19200);
		}
                udelay(50);
        }
...
//Ported acpuclock VDD functions from X8 kernel - khristian
